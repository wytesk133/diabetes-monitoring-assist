...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    // Dequeue the cell.
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"checkIn" forIndexPath:indexPath];
    
    NSInteger bloodSugarIndex = [self.dbManager.arrColumnNames indexOfObject:@"Blood Sugar"];
    NSInteger dateIndex = [self.dbManager.arrColumnNames indexOfObject:@"Date"];
    
    // Set the loaded data to the appropriate cell labels.
    cell.textLabel.text = [NSString stringWithFormat:@"%@", [[self.arrCheckIns objectAtIndex:indexPath.row] objectAtIndex:bloodSugarIndex]];
