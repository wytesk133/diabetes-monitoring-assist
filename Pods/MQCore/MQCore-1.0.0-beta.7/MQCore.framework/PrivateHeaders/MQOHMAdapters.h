 ...
 */
typedef __nullable id(^MQOHMValueAdapterBlock)(__nullable id);
...
/**
 ...
 @param adapterDictionary A dictionary target key, value adapter pairs. The target key (or keys in the dictionary) must be a KVC key the class can already respond to. The value must be a block of type @p OHMValueAdapterBlock, or conforming to the signature @p id(^)(id).
 */
extern void MQOHMSetAdapter(__nonnull Class c, NSDictionary * __nullable adapterDictionary);
...
/**
 ...
 @param adapterDictionary A dictionary target key, value adapter pairs. The target key (or keys in the dictionary) must be a KVC key the class can already respond to. The value must be a block of type @p OHMValueAdapterBlock, or conforming to the signature @p id(^)(id).
 */
extern void MQOHMSetReverseAdapter(__nonnull Class c, NSDictionary * __nullable adapterDictionary);
...
/**
 ...
 @param adapterDictionary A dictionary target key, value adapter pairs. The target key (or keys in the dictionary) must be a KVC key the class can already respond to. The value must be a block of type @p OHMValueAdapterBlock, or conforming to the signature @p id(^)(id).
 */
extern void MQOHMAddAdapter(__nonnull Class c, NSDictionary * __nullable adapterDictionary);
...
/**
 ...
 @param adapterDictionary A dictionary target key, value adapter pairs. The target key (or keys in the dictionary) must be a KVC key the class can already respond to. The value must be a block of type @p OHMValueAdapterBlock, or conforming to the signature @p id(^)(id).
 */
extern void MQOHMAddReverseAdapter(__nonnull Class c, NSDictionary * __nullable adapterDictionary);
 ...
 */
extern void MQOHMRemoveAdapter(__nonnull Class c, NSArray * __nullable keyArray);
...
/**
 ...
 @param keyArray An array of keys to for which adapters should be removed.
 */
extern void MQOHMRemoveReverseAdapter(__nonnull Class c, NSArray * __nullable keyArray);
