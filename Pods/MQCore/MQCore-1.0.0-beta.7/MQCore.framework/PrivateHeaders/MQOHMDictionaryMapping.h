...
#ifndef MQOHMKit_OHMDictionaryMapping_h
#define MQOHMKit_OHMDictionaryMapping_h
 ...
 */
extern void MQOHMSetDictionaryClasses(__nonnull Class class, NSDictionary * __nullable classDictionary);
...
/**
 ...
 @param classDictionary A dictionary source key of strings, and target values of OHMMappable classes.
 */
extern void MQOHMAddDictionaryClasses(__nonnull Class class, NSDictionary * __nullable classDictionary);
 ...
 */
extern void MQOHMRemoveDictionary(__nonnull Class class, NSArray * __nullable keyArray);
